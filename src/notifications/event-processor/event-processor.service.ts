import { Company, ChannelEnum, User } from "src/company-data/company-data.interface";
import { NotificationDataService } from "src/notification-data/notification-data.service";
import { SenderService } from "../sender/sender.service";
import { EmailNotificationStrategy, INotificationStrategy, UINotificationStrategy } from "../sender/sender.strategies";
