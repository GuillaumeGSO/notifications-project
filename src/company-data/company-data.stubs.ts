...
const users4Monster: User[] = [
    ...
    generateUser('12', 'Tom', 'WARWOSKY', 'tom@monster.inc', [
        ChannelEnum.UI,
    ]),
...
const users4Dalton: User[] = [
    ...
    generateUser('21', 'Jack', 'DALTON', 'jack@dalton.com', [
        ChannelEnum.EMAIL,
    ]),
...
const users4Heroes: User[] = [
    ...
    generateUser('42', 'Clark', 'SUPERMAN', 'clark@heroes.com', [
        ChannelEnum.UI,
    ]),
...
const companies: Company[] = [
    ...
    generateCompany('200', 'DALTON Sarl', users4Dalton, [
        ChannelEnum.EMAIL,
    ]),

    generateCompany('300', "THE SIMPSON'S", users4Simpsons, [
        ChannelEnum.UI,
    ]),
